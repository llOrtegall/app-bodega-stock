...
export function RenderMovCom (
  ...
  return (
    <section key={movimientoId} onClick={handleOnClick}
      className='grid grid-cols-12 h-6 text-center border-b dark:border-b-blue-950 py-1 cursor-pointer dark:hover:text-black hover:bg-yellow-100 dark:text-white text-xs text-clip'>
