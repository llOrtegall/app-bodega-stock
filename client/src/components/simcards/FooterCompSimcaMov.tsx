...
export function FooterMovSim({ encargado, incidente, setIncidente, descripcion, setDescripcion, handleClick }: FooterMovSimProps): JSX.Element {
  return (
    <footer className="bg-blue-200 dark:bg-dark-tremor-brand-muted dark:text-white py-2 grid grid-cols-12 place-content-center place-items-center mt-1 px-2">
      <div className="col-span-3 2xl:col-span-3 text-center flex flex-col w-full">
        <Label>Encargado:</Label>
        <Input type="text" value={encargado} readOnly />
      </div>
      <div className="col-span-2 2xl:col-span-2 text-center flex flex-col">
      ...
      <div className="col-span-4 2xl:col-span-5 text-center flex flex-col w-full">
