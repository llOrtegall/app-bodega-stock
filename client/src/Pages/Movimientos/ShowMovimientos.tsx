...
export function ShowMovimientos(): JSX.Element {
  ...
  return (
    loading
      ...
      : (
        <section className="">
          <article className='flex items-center justify-center py-2 gap-2'>
          ...
          <section className=''>
            <article className='grid grid-cols-12 px-2 text-center p-2 font-semibold bg-blue-200 text-xs'>
